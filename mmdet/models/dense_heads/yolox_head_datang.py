...
class YOLOXHead_DT(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(
        ...
        # This flag will be modified by hooks v1.1-6
        self.ues_bound_loss = False
    ...
    def loss(self,
        ...
        (pos_masks, cls_targets, obj_targets, bbox_targets, l1_targets,
         ...
         occs_weight_map, truncate_weight_map) = multi_apply(
        ...
        loss_bbox = torch.sum(
            ...
            truncate_reg_weight_map[pos_masks]) / num_total_samples  # v1.1-2
        ...
        loss_cls = torch.sum(
            ...
            truncate_cls_weight_map[pos_masks]) / num_total_samples  # v1.1-2
    ...
    def _get_target_single(self,
        ...
        if num_igs != 0:
            ...
            with_truncate = self.train_cfg.get('with_truncate',
                                               False)  # v1.1-6
            if with_ignore:
            ...
            if with_truncate:
                gt_bboxes_truncate = gt_bboxes_truncate.to(
                    decoded_bboxes.dtype)
            else:
            ...
            gt_bboxes_truncate_all = torch.cat(
                (gt_bboxes_truncate,
                 gt_bboxes_truncate.new_zeros(num_igs)))  # v1.1-6
