...
CONFIG_FILE = '/home/chenzhen/code/detection/mmdetection/result/' \
              'yolox_s_temp.py'
RESULT_FILE = '/home/chenzhen/code/detection/mmdetection/result/' \
              '2399_results.pkl'
...
if __name__ == '__main__':
    plot_pr_curve(
        config_file=CONFIG_FILE, result_file=RESULT_FILE, metric='bbox')
