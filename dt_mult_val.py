...
def main():
    ...
    config = "/home/chenzhen/code/detection/dt_mmdetection/configs/yolox/yolox_s_temp.py"
    prediction_path = "/home/chenzhen/code/detection/dt_mmdetection/tools/2399_results.pkl"
    area_size = None
